								...
								<div class="col-12">
									<div class="card-body">
										...
										<form class="form-horizontal form-material" id="save_data" name="save_data" method="post">
											<header><b>Twilio SMS settings</b></header> <br><br>
											<section>
												<div class="row">
																...
																<tr class="card-hover">
																	<td class="" colspan="4">
																		<div class="form-group">
																			<label class="custom-control custom-checkbox" style="font-size: 18px;"> <b>Twilio SMS</b>
																			</label>
																		</div>
																	</td>
																	...
																	<td class="">
																		<div class="form-group">
																			<label class="custom-control custom-checkbox" style="font-size: 18px;">
																				<input type="checkbox" class="custom-control-input" name="active_sms" id="active_sms" value="1" 
