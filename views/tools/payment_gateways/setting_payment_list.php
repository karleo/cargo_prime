...
<head>
    ...
    <title>Setting payment list | <?php echo $core->site_name ?></title>
    <!-- This Page CSS -->
    <!-- Custom CSS -->
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Payments apis settings </h4>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 col-xl-12 col-md-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="card-body">
                                    <h4 class="card-title">Payment settings <i class="icon-double-angle-right"></i></h4>
                                </div>
