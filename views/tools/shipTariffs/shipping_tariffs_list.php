...
<head>
    ...
    <title>Shipping rate list | <?php echo $core->site_name ?></title>
    <!-- This Page CSS -->
    <!-- Custom CSS -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="d-md-flex align-items-center">
                                    <div>
                                        <h3 class="card-title">Shipping tariffs list</h3>
                                    </div>
                                </div>
                                    ...
                                    <div class="d-flex">
                                        <div class="mr-auto">
                                            <div class="form-group">
                                                <a href="shipping_tariffs_add.php"><button type="button" class="btn btn-default btn"><i class="ti-plus" aria-hidden="true"></i> Add shipping rates</button></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
