...
<head>
    ...
    <title>City edit | <?php echo $core->site_name ?></title>
    <!-- This Page CSS -->
    <!-- Custom CSS -->
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="form-horizontal form-material" id="update_data" name="update_data" method="post">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mt-3">
                                                <div class="form-group">
                                                    ...
                                                    <input value="<?php echo $row->name; ?>" type="text" class="form-control" name="city_name" id="city_name" placeholder="City name">
                                                </div>
                                            </div>
                                        </div>
                                    </section>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12">
                                            <button class="btn btn-outline-primary btn-confirmation" name="dosubmit" type="submit">Update city</i></span></button>
