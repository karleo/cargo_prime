...
if (empty($_POST['tracking_purchase']))
    ...
    $errors['tracking_purchase'] = 'enter tracking purchase';

if (empty($_POST['provider_purchase']))

    $errors['provider_purchase'] = 'enter provider purchase';

if (empty($_POST['price_purchase']))

    $errors['price_purchase'] = 'enter price purchase';
    ...
    if (isset($_POST["packages"])) {
        ...
        foreach ($packages as $package) {
            ...
            if ($shipment_id !== null) {
                ...
                $subject = "a new shipment has been created, tracking number $order_track";
                            ...
                            $message = $twilio->messages
                                ->create(
                                    ...
                                    array(
                                        ...
                                        "body" => "a new shipment has been registered, *Tracking #$order_track* Follow up on your package by entering the following link and you will have detailed information on the status of your packages $app_url"
                                    )
                                );
                        } catch (Exception $e) {
                        }
                ...
                $dataNotification = array(
                    'user_id' =>  $_SESSION['userid'],
                    'order_id' =>  $shipment_id,
                    'notification_description' => 'There is a new registered package, please check it',
                    'shipping_type' => '4',
